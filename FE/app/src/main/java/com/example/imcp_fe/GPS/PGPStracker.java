...
public class PGPStracker extends Service implements LocationListener {
    ...
    private String gpsurl = "http://tomcat.comstering.synology.me/IMCP_Server/setParentGPS.jsp";
    private String id;
...
//    }
    ...
    private void registerRestartAlarm() {
        ...
        Intent intent = new Intent(PGPStracker.this, Restartservice.class);
        intent.setAction("ACTION.RESTART.GPStracker");
        PendingIntent sender = PendingIntent.getBroadcast(PGPStracker.this, 0, intent, 0);
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(PGPStracker.this);
        }
    }
                    ...
                    public void onResponse(String response) {
                        switch (response) {
                            case "SetGPSSuccess"://toast는 나중에 지워야함
                                ...
                                break;
                            case "NoID":
                                Toast.makeText(mContext, "아이디가 없음", Toast.LENGTH_SHORT).show();
                                break;
                            case "DBError":
